...
export const products: Product[] = [
    {
      ...
      features: ['Clean burn', 'Lasting scent', 'Premium Fragrance Oils','40+ Hour Burn Time', 'Beautiful finish','Our hand-poured candles are designed to soothe, refresh, and elevate your space.'],
    ...
    },
    {
      ...
      features: ['Quick fix', 'Long vibe','A spritz of our room spray instantly transforms your space and uplifts your mood'],
    ...
    },
    {
      ...
      features: ['No fire', 'No fuss','Just constant, gentle fragrance that lingers beautifully throughout your home'],
